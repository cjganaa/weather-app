export function CenterCircle(){
    return(
        <div className="w-[140px] h-[140px] bg-[#F3F4F6] -left-[70px] rounded-full absolute flex justify-center items-center">
            ...
            <div className="rounded-[40px] w-[70px] h-[140px] bg-[#0F141E] top-[134px] right-0 absolute"></div>
            <div className="w-[140px] h-[140px] absolute bg-[#F3F4F6] rounded-full flex items-center justify-evenly">
                <div className="w-[70px] h-[140px] absolute bg-transparent rounded-tl-full rounded-bl-full flex items-center justify-evenly border-l border-t border-b border-gray-600 left-0 opacity-35"></div>
            ...
            <div className="rounded-full w-[340px] h-[340px] border border-gray-600 absolute opacity-35"></div>
            <div className="rounded-full w-[540px] h-[540px] border border-gray-600 absolute opacity-35"></div>
