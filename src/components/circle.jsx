export function CenterCircle(){
    return(
        <div className="w-[140px] h-[140px] bg-[#F3F4F6] -left-[70px] rounded-full absolute flex justify-center items-center">
            <div className="relative w-[50px] h-[200px] bg-[#F3F4F6]"></div>
            <div className="rounded-[40px] w-[70px] h-[140px] bg-[#0F141E] -top-[134px] right-0 absolute"></div>
            <div className="rounded-[40px] w-[70px] h-[140px] bg-[#0F141E] top-[134px] right-0 absolute"></div>
            <div className="w-[140px] h-[140px] bg-[#F3F4F6] rounded-full absolute flex items-center justify-evenly ">
            ...
            <div className="rounded-full w-[340px] h-[340px] border border-gray-600 absolute"></div>
            <div className="rounded-full w-[540px] h-[540px] border border-gray-600 absolute"></div>
            <div className="rounded-full w-[940px] h-[940px] border border-gray-600 absolute"></div>
            <div className="rounded-full w-[1340px] h-[1340px] border border-gray-600 absolute"></div>
            <div className="rounded-full w-[1740px] h-[1740px] border border-gray-600 absolute"></div>
          </div>
    );
}