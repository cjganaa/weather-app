export function Search(){
    return(
        <div className="flex px-4 py-3 rounded-[50px] border-none border-gray-600 overflow-hidden w-[500px] h-fit font-[sans-serif] p-0 drop-shadow-md bg-white absolute left-[40px] top-[40px] z-10">
